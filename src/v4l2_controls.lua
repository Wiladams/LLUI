...
C.V4L2_CID_USER_CLASS 		= bor(V4L2_CTRL_CLASS_USER, 1)
...
C.V4L2_CID_WHITENESS		= (V4L2_CID_GAMMA) -- Deprecated 
...
C.V4L2_CID_USER_MEYE_BASE			= (V4L2_CID_USER_BASE + 0x1000)
C.V4L2_CID_USER_BTTV_BASE			= (V4L2_CID_USER_BASE + 0x1010)
C.V4L2_CID_USER_S2255_BASE		= (V4L2_CID_USER_BASE + 0x1030)
C.V4L2_CID_USER_SI476X_BASE		= (V4L2_CID_USER_BASE + 0x1040)
C.V4L2_CID_USER_TI_VPE_BASE		= (V4L2_CID_USER_BASE + 0x1050)
...
C.V4L2_CID_MPEG_CLASS 			= (C.V4L2_CTRL_CLASS_MPEG | 1)
...
C.V4L2_CID_MPEG_CX2341X_BASE 				= (V4L2_CTRL_CLASS_MPEG | 0x1000)
...
C.V4L2_CID_MPEG_MFC51_BASE				= (C.V4L2_CTRL_CLASS_MPEG | 0x1100)
...
C.V4L2_CID_CAMERA_CLASS_BASE 	= bor(V4L2_CTRL_CLASS_CAMERA, 0x900)
C.V4L2_CID_CAMERA_CLASS 		= bor(V4L2_CTRL_CLASS_CAMERA, 1)
...
C.V4L2_CID_FLASH_CLASS_BASE		= (V4L2_CTRL_CLASS_FLASH | 0x900)
C.V4L2_CID_FLASH_CLASS			= (V4L2_CTRL_CLASS_FLASH | 1)

C.V4L2_CID_FLASH_LED_MODE			= (V4L2_CID_FLASH_CLASS_BASE + 1)



C.V4L2_CID_FLASH_STROBE_SOURCE		= (V4L2_CID_FLASH_CLASS_BASE + 2)


C.V4L2_CID_FLASH_STROBE			= (V4L2_CID_FLASH_CLASS_BASE + 3)
C.V4L2_CID_FLASH_STROBE_STOP		= (V4L2_CID_FLASH_CLASS_BASE + 4)
C.V4L2_CID_FLASH_STROBE_STATUS		= (V4L2_CID_FLASH_CLASS_BASE + 5)

C.V4L2_CID_FLASH_TIMEOUT			= (V4L2_CID_FLASH_CLASS_BASE + 6)
C.V4L2_CID_FLASH_INTENSITY		= (V4L2_CID_FLASH_CLASS_BASE + 7)
C.V4L2_CID_FLASH_TORCH_INTENSITY		= (V4L2_CID_FLASH_CLASS_BASE + 8)
C.V4L2_CID_FLASH_INDICATOR_INTENSITY	= (V4L2_CID_FLASH_CLASS_BASE + 9)

C.V4L2_CID_FLASH_FAULT			= (V4L2_CID_FLASH_CLASS_BASE + 10)
C.V4L2_FLASH_FAULT_OVER_VOLTAGE		= (1 << 0)
C.V4L2_FLASH_FAULT_TIMEOUT		= (1 << 1)
C.V4L2_FLASH_FAULT_OVER_TEMPERATURE	= (1 << 2)
C.V4L2_FLASH_FAULT_SHORT_CIRCUIT		= (1 << 3)
C.V4L2_FLASH_FAULT_OVER_CURRENT		= (1 << 4)
C.V4L2_FLASH_FAULT_INDICATOR		= (1 << 5)

C.V4L2_CID_FLASH_CHARGE			= (V4L2_CID_FLASH_CLASS_BASE + 11)
C.V4L2_CID_FLASH_READY			= (V4L2_CID_FLASH_CLASS_BASE + 12)
...
C.V4L2_CID_JPEG_CLASS_BASE		= (V4L2_CTRL_CLASS_JPEG | 0x900)
C.V4L2_CID_JPEG_CLASS			= (V4L2_CTRL_CLASS_JPEG | 1)
...
C.V4L2_CID_IMAGE_SOURCE_CLASS_BASE	= (V4L2_CTRL_CLASS_IMAGE_SOURCE | 0x900)
C.V4L2_CID_IMAGE_SOURCE_CLASS		= (V4L2_CTRL_CLASS_IMAGE_SOURCE | 1)

C.V4L2_CID_VBLANK				= (V4L2_CID_IMAGE_SOURCE_CLASS_BASE + 1)
C.V4L2_CID_HBLANK				= (V4L2_CID_IMAGE_SOURCE_CLASS_BASE + 2)
C.V4L2_CID_ANALOGUE_GAIN			= (V4L2_CID_IMAGE_SOURCE_CLASS_BASE + 3)
...
C.V4L2_CID_IMAGE_PROC_CLASS_BASE		= (V4L2_CTRL_CLASS_IMAGE_PROC | 0x900)
C.V4L2_CID_IMAGE_PROC_CLASS		= (V4L2_CTRL_CLASS_IMAGE_PROC | 1)

C.V4L2_CID_LINK_FREQ			= (V4L2_CID_IMAGE_PROC_CLASS_BASE + 1)
C.V4L2_CID_PIXEL_RATE			= (V4L2_CID_IMAGE_PROC_CLASS_BASE + 2)
C.V4L2_CID_TEST_PATTERN			= (V4L2_CID_IMAGE_PROC_CLASS_BASE + 3)




--  DV-class control IDs defined by V4L2 
C.V4L2_CID_DV_CLASS_BASE			= (V4L2_CTRL_CLASS_DV | 0x900)
C.V4L2_CID_DV_CLASS			= (V4L2_CTRL_CLASS_DV | 1)

#define	V4L2_CID_DV_TX_HOTPLUG			= (V4L2_CID_DV_CLASS_BASE + 1)
#define	V4L2_CID_DV_TX_RXSENSE			= (V4L2_CID_DV_CLASS_BASE + 2)
#define	V4L2_CID_DV_TX_EDID_PRESENT		= (V4L2_CID_DV_CLASS_BASE + 3)
#define	V4L2_CID_DV_TX_MODE			= (V4L2_CID_DV_CLASS_BASE + 4)
C.V4L2_CID_DV_TX_RGB_RANGE		= (V4L2_CID_DV_CLASS_BASE + 5)




#define	V4L2_CID_DV_RX_POWER_PRESENT		= (V4L2_CID_DV_CLASS_BASE + 100)
C.V4L2_CID_DV_RX_RGB_RANGE		= (V4L2_CID_DV_CLASS_BASE + 101)

C.V4L2_CID_FM_RX_CLASS_BASE		= (V4L2_CTRL_CLASS_FM_RX | 0x900)
C.V4L2_CID_FM_RX_CLASS			= (V4L2_CTRL_CLASS_FM_RX | 1)

C.V4L2_CID_TUNE_DEEMPHASIS		= (V4L2_CID_FM_RX_CLASS_BASE + 1)

C.V4L2_CID_RDS_RECEPTION			= (V4L2_CID_FM_RX_CLASS_BASE + 2)
